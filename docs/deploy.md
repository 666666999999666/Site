...
| `SERVER_APP_DIR` | 项目在服务器上的目录 | `/home/ubuntu/blog` |
...
GITHUB_REPOSITORY=你的GitHub用户名/你的仓库名
```
...
```bash
# 创建证书目录
mkdir -p /home/ubuntu/blog/nginx/certs

# 复制证书文件
sudo cp /etc/letsencrypt/live/yourdomain.com/fullchain.pem /home/ubuntu/blog/nginx/certs/
sudo cp /etc/letsencrypt/live/yourdomain.com/privkey.pem /home/ubuntu/blog/nginx/certs/

# 修改权限，让 nginx 容器能读取
sudo chmod 644 /home/ubuntu/blog/nginx/certs/*.pem
```

### 4.4 修改 nginx 配置支持 HTTPS

编辑 `/home/ubuntu/blog/nginx/conf.d/default.conf`，替换为以下内容：
...
```
0 3 * * * certbot renew --quiet && cp /etc/letsencrypt/live/yourdomain.com/fullchain.pem /home/ubuntu/blog/nginx/certs/ && cp /etc/letsencrypt/live/yourdomain.com/privkey.pem /home/ubuntu/blog/nginx/certs/ && cd /home/ubuntu/blog && docker compose restart nginx
```
